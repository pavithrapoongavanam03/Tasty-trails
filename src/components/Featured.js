...
const [currentIndex, setCurrentIndex] = useState(0)
  ...
  return (
    <div className='max-w-[1520px] h-[500px] w-full py-4 px-4 relative group '>
        ...
        </div> <div className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-5 text-2xl rounded-full  p-2 bg-orange-700 text-white cursor-pointer'>
