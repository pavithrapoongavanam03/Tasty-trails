...
import backgroundImage from '../data/images.jpg'; // Import the background image

const Main= () => {
  return (
    <div className="min-h-screen bg-cover" style={{backgroundImage: `url(${backgroundImage})`}}> {/* Use bg-cover to cover the entire background */}
      <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md bg-white bg-opacity-80 rounded-md px-10 py-8"> {/* Add a semi-transparent white background for the form */}
